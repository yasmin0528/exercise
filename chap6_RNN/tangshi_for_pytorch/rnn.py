...
class RNN_model(nn.Module):
    ...
    def forward(self,sentence,is_test = False):
        ...
        h0 = torch.zeros(2, current_batch_size, self.lstm_dim, device=batch_input.device)
        c0 = torch.zeros(2, current_batch_size, self.lstm_dim, device=batch_input.device)
